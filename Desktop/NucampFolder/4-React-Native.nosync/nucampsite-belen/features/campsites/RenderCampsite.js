...
const RenderCampsite = (props) => {
    ...
    const pansResponder= PanResponder.create({
        ...
        onPanResponderEnd: (e, gestureState => {
            ...
            if (isLeftSwipe(gestureState)) {
                Alert.alert(
                    'Add Favorite',
                    'Are you sure you want to ad ' + campsite.name + ' to favorites?',
                    [
                    {
                        text: 'Cancel',
                        style: 'cancel',
                    ...
                    },
                    {
                        ...
                        ? console.log('Already set a Favorite')
                        : props. markFavorite()
                    }
                ],
                {cancelable: false}
